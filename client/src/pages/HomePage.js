...
function HomePage() {
	return (
	<div className="homepage" style={{ background: '#fff', minHeight: '100vh' }}>
			<HeroCarousel />
			...
			<div style={{ margin: '56px 0 0 0', padding: '0 32px' }}>
				<div style={{ background: '#fafbfc', borderRadius: 12, boxShadow: '0 2px 8px #eee', padding: 32 }}>
					<img src="https://www.tesla.com/sites/default/files/images/supercharger-map.png" alt="Supercharger Map" style={{ width: '100%', borderRadius: 8, marginBottom: 24, maxWidth: '100vw' }} />
					<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
						<div style={{ minWidth: 220 }}>
							...
							<button style={{ background: '#222', color: '#fff', fontWeight: 600, fontSize: 16, borderRadius: 6, padding: '10px 24px', border: 'none', marginRight: 12, marginBottom: 8 }}>View Network</button>
							<button style={{ background: '#f5f5f5', color: '#222', fontWeight: 600, fontSize: 16, borderRadius: 6, padding: '10px 24px', border: 'none', marginBottom: 8 }}>Learn More</button>
						</div>
						<div style={{ textAlign: 'right', minWidth: 180, marginTop: 16 }}>
							<div style={{ fontSize: 24, fontWeight: 700, color: '#d32f2f' }}>33,331 <span style={{ fontSize: 16, color: '#222' }}>Superchargers</span></div>
							<div style={{ fontSize: 24, fontWeight: 700, color: '#888' }}>10,402 <span style={{ fontSize: 16, color: '#222' }}>Destination Chargers</span></div>
						</div>
					</div>
				</div>
			</div>
			...
			<footer style={{ background: '#fff', borderTop: '1px solid #eee', marginTop: 56, padding: '32px 0 0 0' }}>
				...
				<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', alignItems: 'center', gap: 8, marginBottom: 24 }}>
					<button style={{ background: '#f5f5f5', color: '#222', fontWeight: 500, fontSize: 15, borderRadius: 6, padding: '10px 24px', border: 'none', display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
						<span style={{ fontSize: 18 }}>💬</span> Ask a Question
					</button>
					<button style={{ background: '#f5f5f5', color: '#3957ff', fontWeight: 500, fontSize: 15, borderRadius: 6, padding: '10px 24px', border: 'none', display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
